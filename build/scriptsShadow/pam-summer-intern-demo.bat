...
set CLASSPATH=%APP_HOME%\lib\pam-summer-intern-demo-0.1-all.jar

@rem Execute pam-summer-intern-demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PAM_SUMMER_INTERN_DEMO_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
